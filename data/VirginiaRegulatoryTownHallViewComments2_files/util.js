...
DWRUtil.useLoadingMessage = function(message) {
  ...
  else loadingMessage = "Working.... Please wait...";
  DWREngine.setPreHook(function() {
    ...
    if (!disabledZone) {
      ...
      // Figuring out the vertical middle of the screen for different browsers
      var yOffset
      if (self.pageYOffset)
      ...
      messageZone.style.top = Math.floor(300+yOffset)+'px';
      messageZone.style.left = '300px';

      messageZone.style.background = "crimson";
      messageZone.style.fontWeight = "bold";
      messageZone.style.color = "white";
      messageZone.style.fontFamily = "Arial,Helvetica,sans-serif";
      messageZone.style.padding = "8px";
      messageZone.style.border = "1px solid gray";
      ...
      // Moves the previously created loading message box to the current center of the screen
      var yOffset
      if (self.pageYOffset)
          yOffset = self.pageYOffset;
      else if (document.documentElement && document.documentElement.scrollTop)
